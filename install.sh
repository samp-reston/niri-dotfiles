...
readonly CONFIG_FOLDERS=(
	niri waybar fish zsh fastfetch mako ghostty kitty starship
...
readonly PACMAN_PACKAGES=(
	niri waybar fish fastfetch mako ghostty kitty starship neovim yazi
...
install_gtk_themes() {
	...
	if [[ ${#installed_themes[@]} -gt 0 ]]; then
		msg "Successfully installed ${#installed_themes[@]} GTK theme(s): $(
			IFS=' '
...
verify_all_binaries() {
	...
	local binaries_to_check=(
		niri waybar fish fastfetch mako ghostty kitty starship
